...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        jasmine: {
            options: {
                ...
                vendor: ['test/browser/jasmine-jsreporter.js', 'test/browser/common.js', 'test/browser/less'],
        ...
        'saucelabs-jasmine': {
            all: {
                options: {
                    ...
                    testname: 'Sauce Unit Test for less',
                    browsers: [{
                        browserName: "chrome",
                        version: '',
                        platform: 'Windows 8'
        ...
        clean: {
            test: ['test/browser/less', 'tmp', 'test/less-bom'],
    ...
    // Create the browser version of less
